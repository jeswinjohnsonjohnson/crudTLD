                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="#" @submit.prevent="registerEmployee">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="email" v-model="Form.email" id="emailaddress" required placeholder="Enter your email">
                            </div>

                            <div class="mb-3">
                                <label for="password" class="form-label">Password</label>
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" v-model="Form.password" class="form-control" placeholder="Enter your password">
